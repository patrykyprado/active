...
class PagSeguroConfigWrapper
{
    public static function getConfig()
    {
        ...
        $PagSeguroConfig['credentials']['email'] = "financeiroserra@cedtec.com.br";
        $PagSeguroConfig['credentials']['token']['production'] = "55B5184AC3CE4996B870F6F0150E13D4";
...
class CreatePaymentRequest
{
    ...
    public static function main()
    {
        ...
        //$paymentRequest->addPaymentMethodConfig('CREDIT_CARD', 12, 'MAX_INSTALLMENTS_LIMIT');
