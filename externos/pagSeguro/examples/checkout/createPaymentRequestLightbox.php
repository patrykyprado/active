...
class CreatePaymentRequestLightbox
{
    ...
    public static function main()
    {
        ...
        $paymentRequest->addItem('0001', 'Qualificação: Administração da Produção', 1, 149.00);


        // Set a reference code for this payment request, it is useful to identify this payment
        // in future notifications.
        $paymentRequest->setReference("90099633");
        ...
        $paymentRequest->setSender(
            'PATRYKY PRADO DE OLIVEIRA',
            'patryky@soluctti.com.br',
            '27',
            '998450730',
            'CPF',
            '141.253.797-50'
        ...
        $paymentRequest->setRedirectUrl("http://pincelatomico.net.br/pincelatomico");
        ...
        try {
            ...
            $credentials = new PagSeguroAccountCredentials("financeiroserra@cedtec.com.br",
                "55B5184AC3CE4996B870F6F0150E13D4");
