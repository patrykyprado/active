...
<table width=666 cellspacing=0 cellpadding=0 border=0><tr><td valign=top class=cp><DIV ALIGN="CENTER">Instruções
        de Segurança</DIV></TD></TR><TR><TD valign=top class=cp><DIV ALIGN="left">
        <p>
          <B style="color: red; font-size: 12px">ATENÇÃO: CONFIRA SE O BOLETO IMPRESSO POSSUI A LINHA DIGITAVEL COM O INICIO IGUAL A 237 - CÓDIGO DO BANCO BRADESCO.
            <BR>CASO O CÓDIGO ESTEJA DIFERENTE PROCURE A UNIDADE DE ENSINO E SOLICITE O BOLETO.</B>
          <img src="imagens/bradesco-defesa.jpg"/>
...
número</td></tr><tr><td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td><td class=cp valign=top width=298 height=12> 
  <span class="campo"><?php echo substr($dadosboleto["cedente"],0,50); ?></span></td>
...
beneficiario</td></tr><tr><td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td><td class=cp valign=top width=472 height=12>
  <span class="campo">
...
baixa</td></tr><tr><td valign=top width=7 height=1><img height=1 src=imagens/2.png width=7 border=0></td><td valign=top width=472 height=1><img height=1 src=imagens/2.png width=472 border=0></td><td valign=top width=7 height=1><img height=1 src=imagens/2.png width=7 border=0></td><td valign=top width=180 height=1><img height=1 src=imagens/2.png width=180 border=0></td></tr></tbody></table><TABLE cellSpacing=0 cellPadding=0 border=0 width=666><TBODY><TR><TD class=ct  width=7 height=12></TD><TD class=ct  width=409 >Pagador/Avalista</TD><TD class=ct  width=250 ><div align=right>Autenticação
